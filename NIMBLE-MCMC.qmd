...
-   BUGS言語でモデルを記述し、統計モデルのパラメータ推定をおこなうRパッケージ
...
モデルをC++に変換してコンパイルして実行するので、開発環境が必要[^1]

[^1]: Windows: Rtools, macOS: Command Line Tools (あるいはXcode), Linuxほか: それぞれの開発環境
